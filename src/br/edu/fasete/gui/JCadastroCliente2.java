...
public class JCadastroCliente2 extends JInternalFrame {
	/**
	 * 
	 */
	...
	public JCadastroCliente2() {
		...
		lblbtnEditar.addMouseListener(new MouseAdapter() {
			...
			lblNewLabel_1.setIcon(new ImageIcon(JCadastroCliente2.class.getResource("/imagens/novo1.png")));
			exibirpanel.add(lblNewLabel_1, "flowx,cell 4 2,alignx right");
			lblbtnExcluir.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/excluir1.png")));
			exibirpanel.add(lblbtnExcluir, "cell 4 2,alignx right,growy");
			lblbtnEditar.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/confirmarv1.png")));
		...
		cadast.setLayout(new MigLayout("", "[63px][226px][281px][39px][85px][159px][248px][4px][136px]", "[76.00px][33px][52.00px][30px][55.00px][30px][56.00px][30px][57.00px][31px][81.00px]"));
		...
		cadast.add(lblNomeobri, "cell 2 0,alignx left,aligny bottom");
		...
		cadast.add(lblcpfobri, "cell 2 2,growx,aligny bottom");
		...
		cadast.add(lblrgobri, "cell 6 2,alignx left,aligny bottom");
		...
		cadast.add(lblcidadeobri, "cell 2 4,growx,aligny bottom");
		...
		cadast.add(lblestadoobri, "cell 5 4,alignx left,aligny bottom");
		...
		cadast.add(lblenderecoobri, "cell 2 6,growx,aligny bottom");
		lblenderecoobri.setVisible(false);
		
		JLabel lblNumero = new JLabel("N\u00FAmero");
		lblNumero.setForeground(Color.WHITE);
		lblNumero.setFont(new Font("Dialog", Font.PLAIN, 15));
		cadast.add(lblNumero, "cell 4 6,alignx left,aligny bottom");
		...
		cadast.add(lblnumobri, "cell 6 6,alignx left,aligny bottom");
		...
		cadast.add(lblBairroobri2, "cell 2 8,alignx left,aligny bottom");
		...
		cadast.add(lbltelefoneobri, "cell 6 8,alignx left,aligny bottom");
		lbltelefoneobri.setVisible(false);
		numeroField = new JTextField();
		numeroField.setFont(new Font("Tahoma", Font.PLAIN, 15));
		cadast.add(numeroField, "cell 4 7 5 1,grow");
		...
		try {
			...
			cadast.add(lblTelefone, "cell 4 8,alignx left,aligny bottom");
			...
			lblbtnsalvar.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent arg0) {
					...
					c.setEstado(""+comboBoxEstado.getSelectedItem());
					...
					try {
						...
						while(rs.next()) {
							 ...
							 if(cpf != c.getCPF() && c.getCPF().length() == 14 ){
								if(nomeField.getText().isEmpty() || cpfField.getText().isEmpty() || rgField.getText().isEmpty() || telefoneField.getText().isEmpty() || bairroField.getText().isEmpty() || enderecoField.getText().isEmpty()){
								}else{								 
									  cpf = "";																   
									  try {
										  stmt = (PreparedStatement) Conexao.getConnection()
					...
					int opcao2 = JOptionPane.showConfirmDialog(null, "Deseja cadastrar outro cliente?", "Aviso", JOptionPane.YES_NO_OPTION);
					if (opcao2 == 0){	
					nomeField.setText("");
					cpfField.setText("");
					rgField.setText("");
			...
			cadast.add(lblbtncancelar, "cell 6 10,alignx right,aligny bottom");
			lblbtnsalvar.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/salvar1.png")));
			cadast.add(lblbtnsalvar, "cell 8 10,alignx left,aligny bottom");
			...
			telefoneField.addKeyListener(new KeyAdapter() {
				...
				public void keyPressed(KeyEvent e) {
					...
					int opcao2 = JOptionPane.showConfirmDialog(null, "Deseja cadastrar u novo cliente?", "Aviso", JOptionPane.YES_NO_OPTION);
					if (opcao2 == 0){	
					nomeField.setText("");
					cpfField.setText("");
					rgField.setText("");
			...
			cadast.add(telefoneField, "cell 4 9 5 1,grow");
			...
			e1.printStackTrace();
				...
				cadast.add(nomeField, "cell 0 1 9 1,grow");
				...
				try {
					...
					cadast.add(cpfField, "cell 0 3 3 1,grow");
				...
				try {
					...
					cadast.add(bairroField, "cell 0 9 3 1,grow");
					...
					cadast.add(lblEstado, "cell 4 4,growx,aligny bottom");
					...
					cadast.add(comboBoxEstado, "cell 4 5,grow");
					...
					cadast.add(cidadeField, "cell 0 5 3 1,grow");
		...
		nomeField2.setBounds(7, 53, 1392, 33);
		...
		rglabel2.setBounds(678, 109, 574, 19);
		...
		cpfField2.setBounds(7, 132, 643, 33);
		...
		rgField2.setBounds(678, 132, 721, 33);
		...
		estadolabel2.setBounds(678, 191, 44, 19);
		...
		cidadeField2.setBounds(7, 214, 643, 33);
		...
		numerolabel2.setBounds(678, 275, 52, 19);
		...
		enderecoField2.setBounds(7, 298, 643, 33);
		...
		enderecolabel2.setBounds(7, 275, 439, 19);
		...
		numeroField2.setBounds(678, 298, 721, 33);
		...
		telefonelabel2.setBounds(678, 357, 574, 19);
		...
		bairroField2.setBounds(7, 380, 643, 33);
		...
		telefoneField2.setBounds(678, 380, 721, 33);
		...
		estadoField2.setBounds(678, 214, 721, 33);
		...
		pesquisarField.setBounds(7, 448, 439, 34);
		...
		lblPesquisarPorNome.setBounds(7, 425, 129, 19);
		...
		lblNewLabel.setBounds(7, 507, 117, 19);
		...
		try {
			...
			cpfpesqField.setBounds(7, 530, 439, 35);
		...
		lblbtnPesquisarCPF.setBounds(463, 531, 136, 34);
		...
		lblbtnPesquisarCPF.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/pesquisar1.png")));
		editPanel.add(lblbtnPesquisarCPF);
		
		JLabel lblbtnPesquisarNome = new JLabel("");
		lblbtnPesquisarNome.setBounds(463, 448, 136, 34);
		...
		lblbtnPesquisarNome.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/pesquisar1.png")));
		editPanel.add(lblbtnPesquisarNome);
		
		JLabel lblbtnSalvar = new JLabel("");
		lblbtnSalvar.setBounds(1116, 531, 136, 34);
		lblbtnSalvar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				lblbtnSalvar.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/salvar3.png")));
		...
		lblbtnEditar2.setBounds(976, 530, 136, 35);
		...
		lblbtnExcluir2.setBounds(835, 530, 137, 35);
		...
		label.setBounds(695, 530, 136, 35);
		label.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				label.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/cancelar3.png")));
				int opcao = JOptionPane.showConfirmDialog(null, "Deseja cancelar a ediÁ„o?", "Aviso", JOptionPane.YES_NO_OPTION);
				if (opcao == 0){
				numeroField2.setEditable(false);
				nomeField2.setEditable(false);
				cpfField2.setEditable(false);
		...
		editPanel.add(label);
		lblbtnExcluir2.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/excluir1.png")));
		editPanel.add(lblbtnExcluir2);
		lblbtnEditar2.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/editar1.png")));
		editPanel.add(lblbtnEditar2);
		lblbtnSalvar.setIcon(new ImageIcon(JCadastroCliente.class.getResource("/imagens/salvar1.png")));
		editPanel.add(lblbtnSalvar);
		
		JPanel panel = new JPanel();
		panel.setBackground(Color.GRAY);
		panel.setForeground(Color.BLACK);
		panel.setBounds(-15, 424, 1369, 177);
		editPanel.add(panel);
