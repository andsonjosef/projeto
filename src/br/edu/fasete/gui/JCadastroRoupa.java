...
public class JCadastroRoupa extends JInternalFrame {
	...
	public JCadastroRoupa() {
		...
		cadast.setLayout(new MigLayout("", "[136px][83px][87px][89px][203.00px][71px][237px][320.00px,grow]", "[123.00px][33px][116.00px][30px][116.00px][31px][112.00px]"));
		...
		cadast.add(lblModelo, "cell 5 0 3 1,growx,aligny bottom");
		
		ModeloField = new JTextField();
		cadast.add(ModeloField, "cell 5 1 3 1,grow");
		...
		cadast.add(lblTamanho, "cell 5 2,growx,aligny bottom");
		...
		cadast.add(lblestadoobri, "cell 7 2,alignx left,aligny bottom");
		...
		cadast.add(tamanhoField, "cell 5 3 3 1,grow");
		...
		cadast.add(lblPreco, "cell 5 4 3 1,growx,aligny bottom");
		...
		cadast.add(precoField, "cell 5 5 3 1,grow");
		...
		cadast.add(btnLimparTela, "cell 0 6,alignx right,aligny bottom");
		
		
		JButton btnCancelar = new JButton("Cancelar");
		btnCancelar.setFont(new Font("Tahoma", Font.PLAIN, 15));
		cadast.add(btnCancelar, "cell 2 6,alignx left,aligny bottom");
			...
			cadast.add(btnSalvar, "cell 4 6,alignx left,aligny bottom");
...
public void actionPerformed(ActionEvent e) {
		...
		exibirpanel.add(btnEditar, "cell 4 1,alignx left,aligny bottom");
		...
		exibirpanel.add(btnExculir, "cell 2 1,growx,aligny bottom");
		...
		panel.add(lblModelo_1, "cell 1 0 7 1,growx,aligny bottom");
		...
		panel.add(modeloField2, "cell 1 1 7 1,grow");
		...
		panel.add(lblTamanho_1, "cell 1 2 7 1,growx,aligny bottom");
		...
		panel.add(tamanhoField2, "cell 1 3 7 1,grow");
		...
		panel.add(lblPreco_1, "cell 1 4 7 1,growx,aligny bottom");
		...
		panel.add(precoField2, "cell 1 5 7 1,grow");
		...
		panel.add(btnNewButton, "cell 1 7,alignx right,growy");
		
		JButton btnEditar_1 = new JButton("Editar");
		btnEditar_1.setFont(new Font("Tahoma", Font.PLAIN, 15));
		panel.add(btnEditar_1, "cell 3 7,alignx left,growy");
		...
		panel.add(btnExcluir, "cell 5 7,alignx left,growy");
		...
		panel.add(btnSalvar_1, "cell 7 7,alignx left,growy");
