...
public class JRegistro2 extends JInternalFrame {
	...
	public JRegistro2() {
		setTitle("Registro");
		setFrameIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/iconcloset.png")));
		...
		status1box.setModel(new DefaultComboBoxModel(new String[] {"Pendente", "Pago"}));
				...
				cadast.add(cpfField, "cell 0 5 5 1,grow");
					...
					lblbtnConfirmar.addMouseListener(new MouseAdapter() {
						@Override
						public void mouseClicked(MouseEvent e) {
							lblbtnConfirmar.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/confirmar3.png")));
							nomeField2.setText(c.getNome());
							c.setCodCliente(svaluecodCli);
							carregarTabelaRoupaLista();
							Fachada.getInstancia().ListarRegistro(c, a);
					...
					lblbtnConfirmar.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/avan\u00E7ar1.png")));
					...
					editPanel.add(lblFuncionrio, "cell 4 4,alignx left,aligny bottom");
					
					JLabel lblPreo_1 = new JLabel("Pre\u00E7o");
					lblPreo_1.setFont(new Font("Dialog", Font.PLAIN, 15));
					lblPreo_1.setForeground(Color.WHITE);
					editPanel.add(lblPreo_1, "cell 6 4,alignx left,aligny bottom");
					...
					try {
						...
						editPanel.add(lblPagamento, "cell 8 4,alignx left,aligny bottom");
					...
					lblbtnEditar.addMouseListener(new MouseAdapter() {
						@Override
						public void mouseClicked(MouseEvent e) {
							lblbtnEditar.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/editar3.png")));
							Fachada.getInstancia().limparTabela();
					...
					lblbtnExcluir.addMouseListener(new MouseAdapter() {
						@Override
						public void mouseClicked(MouseEvent e) {
							lblbtnExcluir.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/excluir3.png")));
					...
					editPanel.add(funcField, "cell 4 5,grow");
					...
					editPanel.add(precoFieldal, "cell 6 5,grow");
...
String pesq = "";
					...
					lblbtnRemover.addMouseListener(new MouseAdapter() {
						@Override
						public void mouseClicked(MouseEvent e) {
							lblbtnRemover.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/remover3.png")));
					...
					lblbtnAdicionar.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/Adicionar1.png")));
					exibirpanel.add(lblbtnAdicionar, "cell 8 2,alignx right");
					lblbtnRemover.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/remover1.png")));
					...
					try {
						...
						exibirpanel.add(lblFuncionrio_1, "cell 6 3,aligny bottom");
					...
					lblbtnsalvar.addMouseListener(new MouseAdapter() {
						@Override
						public void mouseClicked(MouseEvent e) {
							if(datadevoField2.getText().isEmpty()||datalocaField2.getText().isEmpty()){
								...
								if (opcao == 0){
							lblbtnsalvar.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/salvar3.png")));
							Fachada.getInstancia().ExcluirReg(c,a);
					...
					exibirpanel.add(funcioField2, "cell 6 4,grow");
					...
					lblbtnENcerrar.addMouseListener(new MouseAdapter() {
						...
						public void mouseClicked(MouseEvent e) {
							int opcao = JOptionPane.showConfirmDialog(null, "Realmente excluir o registro?", "Aviso", JOptionPane.YES_NO_OPTION);
							if (opcao == 0){
							lblbtnENcerrar.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/excluir3.png")));
							Fachada.getInstancia().ExcluirReg(c,a);
							tabbedPane.setSelectedIndex(0);
							}
						}
					...
					lblbtnENcerrar.setIcon(new ImageIcon(JRegistro2.class.getResource("/imagens/excluir1.png")));
