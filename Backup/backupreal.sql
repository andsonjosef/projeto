...
INSERT INTO `aluguel` VALUES (4,51,'11/11/2222','12/12/1212',22,121,'','  À vista');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `listafinal` VALUES (5,51,4,'calça','jeans','asdas','assd','asdas',0,22);
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `login` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `login_root` VALUES (1,'aj013','aj013','wtf','idk');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `roupa` (
  `tipo` varchar(20) NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `roupa` VALUES ('casaco','capuz','gg','masculino','preto',0,12,2),('calça','jeans','asdas','assd','asdas',1,22,4),('sapato','social','sdsds','dsdsd','sdsds',0,2121,7),('meia','cano alto','p','masculina','azul',0,12,8),('SAIA','RODADA','4','forro','laranja',0,500,9),('calcinha','preta','é só','a moçada','filé',0,10,10),('ad','sdsdd','sdsd','sds','sds',0,12.24,11);
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
